import { eq, and, or, isNull, ne, gte, desc } from "drizzle-orm";
import { getDb } from "../db/client.js";
import { agents, heartbeatLog, messages, tasks, soulDefinitions, bulletinBoard, agentMemory, projects } from "../db/schema.js";
...
export async function runHeartbeat(agent: typeof agents.$inferSelect): Promise<void> {
  ...
  try {
    ...
    if (!hasReactiveWork && !hasDelegatedWork && !hasReviewsPending && !hasBulletinPosts) {
